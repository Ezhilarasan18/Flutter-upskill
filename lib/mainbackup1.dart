...
//     final double divisionHeight = 12.0; // Increase the bar height here

//     // Draw division bars with different colors
//     for (int i = 0; i < divisions; i++) {
//       final double angle = startAngle + i * divisionAngle;
//       final double x1 = centerX + (radius - divisionHeight / 2) * cos(angle);
//       final double y1 = centerY + (radius - divisionHeight / 2) * sin(angle);
//       final double x2 = centerX + (radius + divisionHeight / 2) * cos(angle);
//       final double y2 = centerY + (radius + divisionHeight / 2) * sin(angle);
